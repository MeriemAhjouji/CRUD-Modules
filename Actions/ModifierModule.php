...
$id = $_GET['id'];
$mod= findModuleByID($id);
$nomMod =$mod["nomM"] ;
$ChargeHS1 = $mod["ChargeHS1"];
$ChargeHS2 = $mod["ChargeHS2"];
$ChargeHS3 = $mod["ChargeHS3"];
$ChargeHS4 = $mod["ChargeHS4"];
$TypeMod = $mod["TypeM"];                                                
$codeF = $mod["codeFk"];
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input name="nomModule" value="<?php echo $nomMod ?>" placeholder="Nom Module" class="form-control" type="text">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 selectContainer">
                        <div class="input-group">
                            ...
                            <select name="typeM" class="form-control selectpicker">
                                ...
                                <option selected= <?php $TypeMod=='T'? "selected":"" ?> >T</option>
                                <option selected= <?php $TypeMod=='A'? "selected":"" ?> >A</option>
                                <option selected= <?php $TypeMod=='R'? "selected":"" ?> >R</option> 
                                 </select> 
                        </div>
                    </div>
                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input name="ChargeHS1" value="<?php echo $ChargeHS1 ?>" placeholder="ChargeHS1" class="form-control"
                                                type="number">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-user"></i></span>
                                            <input name="ChargeHS2"  value="<?php echo $ChargeHS2 ?>" placeholder="ChargeHS2" class="form-control" type="number">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-user"></i></span>
                                            <input name="ChargeHS3"  value="<?php echo $ChargeHS3 ?>" placeholder="ChargeHS3" class="form-control"
                                                type="number">
                                        </div>
                                    </div>
                                </div> <!-- nmber input-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 inputGroupContainer">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-user"></i></span>
                                            <input name="ChargeHS4"  value="<?php echo $ChargeHS4 ?>" placeholder="ChargeHS4" class="form-control"
                                                type="number">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php
                                            ...
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                ...
                                                if(isset( $_POST["codeF"]) && isset($_POST["typeM"]) && $nomMod!=""){
                                                    ...
                                                    modifierModule($id,$nomMod,$TypeMod,$ChargeHS1,$ChargeHS2,$ChargeHS3,$ChargeHS4,$codeF);
